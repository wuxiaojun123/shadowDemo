...
public class BinderUuidManager implements UuidManager{
    ...
    private void checkException(Parcel _reply) throws FailedException,NotFoundException {
        ...
        } else if (i == UuidManager.TRANSACTION_CODE_NOT_FOUND_EXCEPTIOIN) {
    ...
    @Override
    public InstalledApk getPlugin(String uuid, String partKey) throws RemoteException, NotFoundException, FailedException {
    ...
    @Override
    public InstalledApk getPluginLoader(String uuid) throws RemoteException, NotFoundException, FailedException {
        Parcel _data = Parcel.obtain();
        Parcel _reply = Parcel.obtain();
        InstalledApk _result;
        try {
    ...
    @Override
    public InstalledApk getRuntime(String uuid) throws RemoteException, NotFoundException, FailedException {
        Parcel _data = Parcel.obtain();
        Parcel _reply = Parcel.obtain();
        InstalledApk _result;
        try {
